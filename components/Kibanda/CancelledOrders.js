...
function CancelledOrders() {
  ...
  const [kibandaOrders, setKibandaOrders] = useState(
    AppCtx.kibandaOrders.filter(
      (order) =>
        order.order_status.toLowerCase() === "Cancelled".toLowerCase() &&
  ...
  useEffect(() => {
    if (AppCtx.activeKibandaOrderMetadata.tab) {
      ...
      if (shouldRefresh && tab === "Cancelled Orders") {
        fetchOrders();
    ...
    >
      ...
      {kibandaOrders.length < 1 && (
        ...
        >
          ...
          >
            No orders cancelled by customers
          </Text>
          <HelperText
            padding="none"
            style={{
      ...
      >
        ...
        */}
            ...
            >
              ...
              >
                Cancelled By Customer ({totalOrders})
              </Text>
              <TouchableOpacity>
                <Text
                  style={{
